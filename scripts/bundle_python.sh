...
echo "🐍 Bundling Python for Friday distribution..."
...
echo "📁 Bundled executable: resources/friday_ollama"
echo ""
echo "The app now includes:"
echo "• Standalone Python executable with all dependencies"
echo "• Automatic Ollama installation capability"
echo "• No external Python requirement for users" 